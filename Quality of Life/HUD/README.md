...
**Description:**  
Allows you to have a custom timer, default is 5 seconds, press 1,2,3,4,5,Q, scroll up and scroll down to trigger the timer.There will be a hint when the time is up
